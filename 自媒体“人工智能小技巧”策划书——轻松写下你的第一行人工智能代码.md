...
随着人工智能、大数据、区块链、物联网、智能制造、5G通信、下一代互联网与实体经济的融合，各行各业急需深度学习、数据挖掘、计算机网络开发的相关人才。
...
有许多现成的开源项目帮助初学者快速开发人工智能与大数据应用，甚至只需用户傻瓜式的设定几个参数即可。比如谷歌的Tensorflow、Facebook的Caffe、百度的Paddle Paddle、Linux微型电脑树莓派、微软的Congnitive Service等等。还有世界上最大的开源代码托管社区Github等。同济大学有强大的开源社区与微软亚洲研究院技术支持。
